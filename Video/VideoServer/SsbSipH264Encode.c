...
void *SsbSipH264EncodeGetInBuf(void *openHandle, long size)
{
        ...
        /////////////////////////////////////////////////
        /*
        fprintf(stderr, "ok before (DeviceIoControl)\n");
        if(pCTX->fInit == 1)
            fprintf(stderr, "ok before mfc_args.get_buf_addr.in_usr_data\n");
        else
            fprintf(stderr, "fail before mfc_args.get_buf_addr.in_usr_data\n");
         */
